# Generated by Django 2.1.5 on 2019-10-21 07:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False, verbose_name='是否为cative')),
            ],
            options={
                'verbose_name': '轮播图',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=20, verbose_name='连接名称')),
                ('link_url', models.URLField(max_length=100, verbose_name='网址')),
            ],
            options={
                'verbose_name': '连接名称',
                'verbose_name_plural': '连接名称',
            },
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.AddField(
            model_name='article',
            name='tui',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='blog.Tui', verbose_name='推荐'),
        ),
        migrations.AddField(
            model_name='article',
            name='user',
